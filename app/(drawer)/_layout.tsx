  ...
  return (
    <ProtectedRoute>
      ...
      >
        ...
        <Drawer.Screen
          name="hospitals"
          options={{ title: "Hospitals", ...hidden }}
        />
        <Drawer.Screen
          name="appointments"
          options={{ title: "My Appointments", ...hidden }}
        />
        <Drawer.Screen
          name="reviews"
          options={{ title: "Reviews & Ratings", ...hidden }}
        />
        <Drawer.Screen
          name="profile"
          options={{ title: "Profile", ...hidden }}
        />
        <Drawer.Screen
          name="consult-online"
          options={{ title: "Consult Online", ...hidden }}
        />
        <Drawer.Screen
          name="consultations"
          options={{ title: "My Consultations", ...hidden }}
        />
        <Drawer.Screen
          name="emergency"
          options={{ title: "Emergency Help", ...hidden }}
        />
        ...
        <Drawer.Screen
          name="health/records"
          options={{ title: "Health Records", ...hidden }}
        />
        <Drawer.Screen
